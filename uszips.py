...
# data setup
engine = create_engine("mysql+mysqldb://root:Njmitx123@localhost/where_are_your_stores?host=localhost?port=3306")
conn = engine.connect()
...
def getZips():
	...
	for aRec in res:
		...
		zDict["Pop"] = aRec.Population
		zDict["Income"] = aRec.Wealthy
